            ...
            try
            {
                ...
                else if (item.ClassCode == scenario_structure_bsp)
                {
                    content = engineType switch
                    {
                        ...
                        BlamEngine.HaloReach when cacheType >= CacheType.HaloReachBeta => item.ReadMetadata<HaloReach.ScenarioStructureBspTag>(),
                ...
                else if (item.ClassCode == scenario)
                {
                    content = engineType switch
                    {
                        ...
                        BlamEngine.HaloReach when cacheType >= CacheType.HaloReachBeta => item.ReadMetadata<HaloReach.ScenarioTag>(),
