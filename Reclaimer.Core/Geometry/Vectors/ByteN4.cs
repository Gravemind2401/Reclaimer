...
namespace Reclaimer.Geometry.Vectors
{
    ...
    public record struct ByteN4 : IVector4, IBufferableVector<ByteN4>
    {
        ...
        private static readonly PackedVectorHelper helper = PackedVectorHelper.CreateSignExtended(8);
        ...
        public float Z
        {
            readonly get => helper.GetValue(zbits);
            set => helper.SetValue(ref zbits, value);
        }

        public float W
        {
            readonly get => helper.GetValue(wbits);
