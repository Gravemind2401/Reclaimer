...
namespace Reclaimer.Geometry.Vectors
{
    ...
    public struct UHenDN3 : IEquatable<UHenDN3>, IVector3, IReadOnlyVector3, IBufferableVector<UHenDN3>
    {
        ...
        private static UHenDN3 ReadFromBuffer(ReadOnlySpan<byte> buffer) => new UHenDN3(BitConverter.ToUInt32(buffer));
        void IBufferable<UHenDN3>.WriteToBuffer(Span<byte> buffer) => BitConverter.GetBytes(bits).CopyTo(buffer);
