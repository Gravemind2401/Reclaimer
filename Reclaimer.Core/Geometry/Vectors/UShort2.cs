...
namespace Reclaimer.Geometry.Vectors
{
    ...
    public record struct UShort2(ushort X, ushort Y) : IVector2, IBufferableVector<UShort2>
    {
        ...
        private static ushort Clamp(in float value) => (ushort)Math.Clamp(value, 0f, ushort.MaxValue);
        ...
        readonly void IBufferable.WriteToBuffer(Span<byte> buffer) => MemoryMarshal.Cast<ushort, byte>([X, Y]).CopyTo(buffer);
