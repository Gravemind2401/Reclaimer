# https://raw.githubusercontent.com/robertguetzkow/blender-python-examples/master/add_ons/install_dependencies/install_dependencies.py
...
def install_and_import_module(module_name, package_name=None, global_name=None, install_args=None):
    """
