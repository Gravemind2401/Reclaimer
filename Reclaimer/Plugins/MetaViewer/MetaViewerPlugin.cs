        ...
        internal sealed class MetaViewerSettings : IPluginSettings
        {
            ...
            void IPluginSettings.ApplyDefaultValues(bool newInstance)
            {
                ...
                PluginProfiles = new List<PluginProfile>
                {
                    ...
                    new PluginProfile("Halo3PreAlpha", CacheType.Halo3PreAlpha),
                    new PluginProfile("Halo3Alpha", CacheType.Halo3Alpha),
                    new PluginProfile("Halo3Beta", CacheType.Halo3PreAlpha, CacheType.Halo3Alpha, CacheType.Halo3Beta),
